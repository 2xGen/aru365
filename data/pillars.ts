...
export const pillars: Pillar[] = [
  {
    ...
    title: "Catamaran Cruises in Aruba | Snorkel, Open Bar & More",
    description:
      "Best catamaran cruises in Aruba: snorkel tours, open bar sails, Antilla wreck excursions, and family catamaran trips. Compare options, read reviews, and book with free cancellation.",
    subPages: [
    ...
    faqs: [
      { question: "What is the best catamaran tour in Aruba?", answer: "Top-rated options include the Dolphin Catamaran Snorkel with Open Bar, the Arusun Catamaran Sail with Snorkeling, and the Antilla Shipwreck and Catalina Bay Snorkel Sail. All are highly reviewed and include snorkeling stops and an open bar. Compare ratings and prices to find the right fit for your group." },
      { question: "How long do catamaran cruises in Aruba usually last?", answer: "Most daytime catamaran cruises in Aruba run between 3 and 5 hours, including one or two snorkeling stops and lunch or an open bar. Half-day and full-day options are both available." },
      { question: "Do I need to book a catamaran cruise in Aruba in advance?", answer: "Yes. The best catamaran cruises sell out, especially in high season (December–April). Booking in advance secures your spot and often a better price." },
      { question: "What is included on a catamaran cruise in Aruba?", answer: "Most tours include the sail, snorkeling gear, instruction, and at least soft drinks. Many add lunch, snacks, and an open bar (cocktails, beer, wine). Check each listing for exact inclusions." },
      { question: "Which catamaran cruises in Aruba include the Antilla shipwreck?", answer: "Several tours visit the Antilla, Aruba's most famous wreck—a large German freighter that makes for spectacular snorkeling. Look for tours that list 'Antilla' as a snorkel stop. Visibility is usually best in calm morning conditions." },
      { question: "Are catamaran tours in Aruba good for families?", answer: "Yes. Catamarans are stable and spacious, making them well-suited for families with kids. Look for tours that label themselves family-friendly; they typically offer life vests, light snorkeling, and soft drinks for children." },
      { question: "Is a catamaran cruise in Aruba suitable for non-swimmers?", answer: "Yes. Snorkeling is optional—you can relax on deck and enjoy the sail and views. Catamarans are stable, so motion sickness is less of a concern than on smaller boats." },
      { question: "What should I bring on a catamaran cruise in Aruba?", answer: "Wear a swimsuit, bring a towel, reef-safe sunscreen, and a hat. Some operators provide rash guards; check when you book. Leave valuables at the hotel or in a dry bag." },
  ...
  },
  {
    ...
    title: "Best Sunset Cruises & Dinner Cruises in Aruba",
    description:
      "Book the best sunset cruises and dinner cruises in Aruba: catamaran sunset sails, open bar cruises, romantic dinner on the water, and happy hour pirate sails. Compare prices and book with free cancellation.",
    subPages: [
    ...
    faqs: [
      { question: "What is the best sunset cruise in Aruba?", answer: "Top-rated options include the Arusun Catamaran Sunset Sail, the Havana's Sunset Cruise, and the Palm Pleasure Sunset Sail. All depart around golden hour and include an open bar. If you want a dinner option, look for sails that include a buffet or plated meal on board." },
      ...
      { question: "How much does a sunset cruise in Aruba cost?", answer: "Sunset cruises in Aruba typically range from $55 to $120+ per person depending on the boat, duration, and what's included (drinks only vs dinner). Compare prices and inclusions on each listing." },
      { question: "When is the best time for a sunset cruise in Aruba?", answer: "Sunset in Aruba is roughly 6:30–7:00 pm depending on the season. Cruises depart 1–2 hours before sunset so you're on the water for golden hour. Operators adjust departure times throughout the year." },
      { question: "How long do sunset cruises in Aruba last?", answer: "Most sunset cruises in Aruba run 2–3 hours from check-in to return. Dinner cruises may run slightly longer. Your confirmation will state the exact duration." },
      { question: "What is the difference between a sunset cruise and a dinner cruise in Aruba?", answer: "A sunset cruise typically focuses on golden-hour sailing with an open bar and light snacks. A dinner cruise includes a full meal (buffet or plated) served on board in addition to drinks. Both depart around the same time—choose based on whether you want a full meal on the water." },
      { question: "Are sunset cruises in Aruba good for families?", answer: "Yes. Many sunset cruises welcome families—soft drinks for kids, open bar for adults, calm evening waters. Some offer pirate or themed sails that children enjoy. Check whether the cruise is romantic-only or family-friendly when you book." },
      { question: "What should I bring on a sunset cruise in Aruba?", answer: "Wear comfortable clothes; a light layer can be useful after sunset on the water. Bring a camera or phone for photos. Most operators include drinks (and dinner if applicable). Leave valuables at the hotel or in a secure bag." },
      { question: "Where do sunset cruises in Aruba depart from?", answer: "Sunset cruises typically depart from marinas in the Palm Beach, Noord, or Oranjestad area. Your booking confirmation will include the exact pier and check-in time. Some tours offer optional hotel pickup." },
    ],
  },
  {
    slug: "snorkeling-and-diving-in-aruba",
    title: "Snorkeling & Scuba Diving in Aruba | Antilla, Red Sail & More",
    description:
      "Book snorkeling and scuba diving tours in Aruba: two-tank dives, Red Sail Sports dive excursions, Antilla shipwreck snorkel, beginner discover dives, and guided reef trips. Compare prices and book with free cancellation.",
    subPages: [
    ...
    faqs: [
      { question: "Where is the best snorkeling in Aruba?", answer: "Top spots include Malmok Beach, Boca Catalina, Mangel Halto (south coast reef), turtle habitats along the coast, and the Antilla shipwreck. Many tours combine several sites in one trip. Guided tours take you to the best conditions on the day." },
      { question: "What is the Antilla shipwreck snorkel tour in Aruba?", answer: "The Antilla is Aruba's most famous snorkel and dive site—a large WWII German freighter sunk off the northwest coast. At around 8–12 meters depth, it's diveable and in some parts accessible to snorkelers. Several tours combine Antilla with a catamaran cruise or boat trip. It's one of the best wreck dives in the Caribbean." },
      { question: "What is Red Sail Sports Aruba?", answer: "Red Sail Sports is one of Aruba's most established watersports operators. They offer one- and two-tank scuba dives, discover scuba courses, snorkeling tours, and sailing. Their dive trips depart from Oranjestad and Palm Beach area. Booking in advance is recommended as popular dive slots fill quickly." },
      { question: "What is a two-tank dive in Aruba?", answer: "A two-tank dive is a certified diver excursion that includes two consecutive dives at different sites—typically a reef and a wreck (such as the Antilla). Most two-tank dives in Aruba last 3–4 hours including briefing, travel, and surface intervals. You need a valid scuba certification (PADI, SSI, or equivalent)." },
      { question: "Do I need experience to snorkel in Aruba?", answer: "No. Most snorkel tours are suitable for beginners. Operators provide equipment and basic instruction; calm, warm water makes Aruba ideal for first-timers. Mention that you're new when booking so the guide can help." },
      { question: "Do I need to be certified to scuba dive in Aruba?", answer: "No, for discover or introductory dives—these let you try scuba with an instructor without any certification. For one- or two-tank boat dives you need a valid certification (e.g. PADI, SSI) and must show your card at check-in." },
      { question: "What is included on a snorkeling or diving tour in Aruba?", answer: "Snorkel tours typically include mask, snorkel, fins, life jacket, guide, and instruction. Dive tours include tanks, weights, briefing, and a guide or instructor. Check each listing for exact inclusions, sites visited, and duration." },
      { question: "What should I bring for snorkeling or diving in Aruba?", answer: "Wear a swimsuit and bring a towel and reef-safe sunscreen. Operators provide snorkel and dive gear. For scuba, bring your certification card. Avoid chemical sunscreens that harm coral—many operators specifically request reef-safe products." },
      { question: "Where do snorkeling and diving tours depart from in Aruba?", answer: "Departure points vary—some tours leave from marinas in Palm Beach or Oranjestad, others from shore. Your booking confirmation will include the exact meeting point. Some offer optional hotel pickup." },
    ],
  },
  {
    slug: "atv-and-jeep-tours-in-aruba",
    title: "ATV & UTV Tours in Aruba | Natural Pool, Desert & More",
    description:
      "ATV tours, UTV tours, and jeep safaris in Aruba: explore the Natural Pool, north coast desert, cave pools, and Secret Beach. Single, double, and 4-seater options. Compare and book with free cancellation.",
    subPages: [
    ...
    faqs: [
      { question: "What is the best ATV tour in Aruba?", answer: "Top-rated ATV and UTV tours visit the Natural Pool (Conchi), north coast desert, cave pools, and Secret Beach. Popular options include the 4-hour north coast ATV desert adventure and UTV tours with a cave pool swim and optional Aruban lunch. Compare ratings and inclusions to find the best fit." },
      { question: "What is the difference between an ATV and a UTV tour in Aruba?", answer: "ATVs are single- or double-seater all-terrain vehicles you straddle like a motorcycle; UTVs (side-by-sides) seat 2–4 people in a cab with seatbelts. UTVs are often easier for couples or small groups. Both offer the same off-road routes; choose based on how many people are in your group and your comfort level." },
      { question: "Do ATV tours in Aruba go to the Natural Pool?", answer: "Many ATV and UTV tours include a stop at the Natural Pool (Conchi)—a natural rock pool on Aruba's rugged north coast that's only reachable by off-road vehicle or boat. Some tours also add nearby cave pools, cliff jumping, or snorkeling. Check each listing for exact stops." },
      { question: "What is the Aruba north coast ATV desert adventure?", answer: "The north coast ATV desert tour is one of Aruba's most popular off-road experiences. It takes you across the island's rugged northeast terrain—cacti, volcanic rock, hidden beaches, and coastal cliffs—often including the Natural Pool and cave pool as swim stops. Duration is typically 3–4 hours." },
      { question: "How much does an ATV or UTV tour in Aruba cost?", answer: "ATV and UTV tours in Aruba typically range from $80–$180 per person depending on vehicle type (single vs double ATV, UTV), duration, and inclusions (Natural Pool, lunch, cave pool). Compare current prices on each listing." },
      { question: "Do I need a license to drive an ATV in Aruba?", answer: "Most ATV and UTV tours require a valid driver's license to operate the vehicle. Passengers don't need one. Minimum age for drivers is usually 18+; riders can often join from age 6. Some tours offer UTVs with a guide driving so you can ride without driving yourself." },
      { question: "What should I bring on an ATV or UTV tour in Aruba?", answer: "Wear closed-toe shoes, long pants or clothes you don't mind getting dusty, and sunglasses. Bring a swimsuit and towel if your tour includes a Natural Pool or beach stop. Helmets are provided. Many tours include water and snacks; some add lunch." },
      { question: "How long are ATV and UTV tours in Aruba?", answer: "Most tours run 2–4 hours. Half-day tours (around 4 hours) often include the Natural Pool, cave explorer route, or lunch. Shorter 2–3 hour options focus on a specific area. Your confirmation will state the exact duration." },
      { question: "Where do ATV and UTV tours in Aruba start?", answer: "Tours start at the operator's base (often in the north or near the Natural Pool area) or with hotel pickup if included. Your confirmation will include the exact meeting point or pickup details." },
    ],
  },
  {
  ...
  },
  {
    ...
    title: "Private Boat Charter & Luxury Tours in Aruba",
    description:
      "Private boat charters in Aruba for snorkeling and sunset sails, VIP airport services, private jeep tours, and luxury dinner experiences. Book your exclusive Aruba experience.",
    subPages: [
    ...
    faqs: [
      { question: "How much does a private boat charter in Aruba cost?", answer: "Private boat charters in Aruba typically start from $300–$600+ per trip depending on the vessel, duration, and what's included (snorkeling gear, drinks, food). You pay for the boat, not per person—great value for groups. Compare current prices on each listing." },
      { question: "What can I do on a private boat charter in Aruba?", answer: "Popular private charter itineraries include snorkeling at reefs and the Antilla wreck, sunset sails along the coast, or a custom route combining both. Operators can often accommodate requests for specific stops, food, and drinks." },
      { question: "How many people fit on a private boat charter in Aruba?", answer: "Capacity depends on the vessel—many private charters suit 2–12 guests. Some larger boats accommodate more. Private charters are ideal for couples, families, and small groups who want a boat to themselves." },
      { question: "Can I book a private sailboat in Aruba?", answer: "Yes. Several operators offer private sailboat charters for snorkeling, sunset, or custom itineraries. These are ideal for couples and small groups who want an intimate experience without other passengers." },
      { question: "How much do private tours in Aruba cost?", answer: "Prices vary by group size, duration, and activity. VIP airport hosting, private transfers, and private charters typically start in the hundreds of dollars; luxury dinner experiences vary. Check each listing for current pricing." },
      { question: "Can I customize a private tour in Aruba?", answer: "Yes. Most private and luxury operators allow custom itineraries, pickup times, and special requests (food, drinks, route). Book in advance to arrange details with the operator." },
      { question: "What is VIP airport hosting in Aruba?", answer: "A host meets you at the airport and assists you through arrival (customs, baggage) or departure (check-in, security to gate). Stress-free start or end to your trip." },
      { question: "What is included in a luxury dinner experience in Aruba?", answer: "Typically a premium dinner (on a cruise or in a cabana), drinks, and a romantic or exclusive setting. Exact menu and inclusions vary by operator—check each tour for details." },
    ],
  },
  {
  ...
  },
  {
    ...
    title: "Sea Glass Island Aruba – Tours & How to Get There",
    description:
      "How to get to Sea Glass Island in Aruba, the best kayak and boat tours (morning, afternoon, sunset, clear kayak), and what to expect at this unique sea glass beach. Compare options and book.",
    subPages: [
    ...
    faqs: [
      { question: "What is Sea Glass Island in Aruba?", answer: "Sea Glass Island (also spelled Seaglass Island) is a small coastal area in Aruba where decades of tumbled glass—bottles, jars, and glass fragments—have washed ashore, creating a colorful, photogenic beach. It's one of Aruba's most unique and popular tour destinations." },
      { question: "How do you get to Sea Glass Island in Aruba?", answer: "You can only reach Sea Glass Island by water—you cannot walk or drive there. The most common ways are a guided kayak tour (you paddle from a nearby launch point) or a boat tour. Most tours take 2–3 hours round-trip including time on the island." },
      { question: "How far is Sea Glass Island from Palm Beach Aruba?", answer: "Sea Glass Island is located on the northwest coast of Aruba, roughly 15–20 minutes by kayak or a short boat ride from common launch points near Palm Beach and Malmok. Most tours meet near the water's edge in this area." },
      { question: "Are Sea Glass Island tours good for beginners?", answer: "Yes. Many kayak tours to Sea Glass Island are designed for beginners. Operators provide instruction, stable sit-on-top kayaks, and life jackets. Clear-kayak and boat options are available if you prefer not to paddle." },
      { question: "What is included on a Sea Glass Island tour?", answer: "Typically: kayak or boat transport, life jacket, paddle (for kayak tours), safety briefing, and guided time on the island. Some tours add snorkeling, sunset viewing, or refreshments. Check each listing for exact inclusions." },
      { question: "Can I take sea glass home from Sea Glass Island?", answer: "Policies vary by operator and local rules. Some tours allow you to pocket a small amount of sea glass as a souvenir; others ask you to leave it to preserve the beach. Your guide will explain on the day." },
      { question: "When is the best time for a Sea Glass Island tour?", answer: "Morning tours offer calmer water and fewer crowds; afternoon and sunset tours give golden light. Book in advance in peak season (December–April)—group sizes are limited and tours fill quickly." },
      { question: "What is the sea glass island aruba tour price?", answer: "Prices vary by tour type and group size—kayak tours typically start from $40–$60 per person; boat tours may vary. Compare current prices and availability on each listing." },
    ],
  },
  {
    slug: "water-sports-and-rentals-in-aruba",
    title: "Jet Ski Rental & Water Sports in Aruba | Palm Beach",
    description:
      "Jet ski rentals in Aruba (Palm Beach & Eagle Beach), parasailing, water skiing, waverunner rentals, flyboarding, and tubing. Compare prices, check availability, and book with free cancellation.",
    subPages: [
    ...
    faqs: [
      { question: "Where can I rent a jet ski in Aruba?", answer: "Jet ski rentals in Aruba operate mainly from Palm Beach, Eagle Beach, and nearby marinas. Operators along the Palm Beach hotel strip are the most accessible—your confirmation will include the exact launch point." },
      { question: "How much does jet ski rental cost in Aruba?", answer: "Jet ski rental in Aruba typically costs $50–$90 for 30 minutes depending on the operator and whether it's a single or double seater (Waverunner). Prices vary—compare current rates on each listing." },
      { question: "What water sports are available in Aruba?", answer: "Popular options include jet ski (Waverunner) rentals, parasailing, water skiing, wakeboarding, tubing, flyboarding, and jetovator. Most operate from Palm Beach or Eagle Beach. Kayaking and paddleboarding are offered at other beaches." },
      { question: "Do I need to book water sports in Aruba in advance?", answer: "Walk-ups are possible but booking ahead secures your preferred time slot and often a better price. Jet skis and parasailing fill quickly in peak season (December–April)—book a few days ahead." },
      { question: "How long are jet ski and parasailing sessions in Aruba?", answer: "Jet ski rentals are typically 30 minutes; parasailing flights are 10–15 minutes in the air plus boat time. Tubing and flyboarding are usually 15–30 minutes. Check each listing for exact duration." },
      { question: "Do I need a license for jet ski rental in Aruba?", answer: "Most operators require a valid driver's license to operate a jet ski. Passengers usually don't need one. Minimum age for drivers varies—check each listing when you book." },
  ...
  },
  {
    ...
    title: "Best Family Activities in Aruba | Things to Do with Kids",
    description:
      "Best family activities and tours in Aruba for kids of all ages: snorkeling, catamaran cruises, jeep tours, horseback riding, and more. Compare options and book family-friendly experiences with free cancellation.",
    subPages: [
    ...
    about:
      "Aruba is one of the most family-friendly destinations in the Caribbean—calm, turquoise water, predictable weather, and a wide range of tours and activities suited to children. From beginner snorkeling and catamaran cruises to ATV rides and island jeep tours, most operators accommodate families with kids. Many tours offer child pricing and life vests; some are exclusively family-focused with gentle pace and fun stops. Compare options and find activities that match your kids' ages and energy level.",
    insiderTips: [
      "Book tours that list minimum age requirements—most family snorkel and cruise tours welcome kids 6+.",
      "Morning tours are usually calmer and cooler; kids tend to do better with earlier start times.",
      "Catamaran cruises and snorkeling tours are great first-time water experiences for children.",
      "Look for tours that include a beach or swim stop—kids love the free play time between activities.",
    ],
    whatToExpect: [
      "Most family tours include hotel pickup or a central meeting point—check your confirmation.",
      "Operators provide life vests, child-sized snorkel gear, and basic safety briefings.",
      "Tours move at a relaxed pace; guides are experienced with families and young children.",
      "Duration ranges from 2 hours (water activities) to a full day (island jeep tours with lunch).",
    ],
    whoIsThisFor: [
      "Families with young children looking for safe, age-appropriate activities.",
      "Parents who want guided experiences so they can relax while kids explore.",
      "Multi-generational groups—grandparents, parents, and kids all welcome on most tours.",
    ],
    highlights: [
      "Family snorkeling in Aruba's calm bays and turtle habitats",
      "Catamaran cruises with soft drinks, life vests, and child-friendly snorkeling",
      "Jeep and island tours with stops at caves, beaches, and landmarks",
      "Beginner-friendly water sports and kayak adventures",
    ],
    faqs: [
      { question: "What are the best family activities in Aruba?", answer: "Top picks for families include catamaran snorkel cruises, turtle-spotting snorkel tours, jeep island tours with beach stops, Sea Glass Island kayak tours, and sunset cruises that welcome kids. Most tours list age requirements—compare options and book in advance." },
      { question: "Is Aruba good for families with kids?", answer: "Yes. Aruba is one of the most family-friendly Caribbean islands. The water is calm, the weather is predictable (low hurricane risk), and there are plenty of guided tours that cater specifically to children. Crime is low and the island is easy to navigate." },
      { question: "What are the best Aruba tours for families?", answer: "Family favorites include snorkeling catamaran cruises, guided jeep island tours, horseback riding, kayak tours to Sea Glass Island, and submarine or glass-bottom boat experiences for younger kids who aren't ready to snorkel." },
      { question: "What age is suitable for Aruba water tours?", answer: "Many snorkel and catamaran tours welcome kids 6 and up; some allow younger children. Life vests are always provided. Parasailing and jet ski driving are typically 18+. Check each tour listing for exact age and weight requirements." },
      { question: "Are there tours in Aruba for toddlers or young children?", answer: "Yes. Calm-water catamaran sails, glass-bottom boat tours, and gentle kayak experiences can suit younger children. Avoid high-energy water sports. Always check the minimum age on each listing before booking." },
      { question: "What is the best family tour in Aruba for snorkeling?", answer: "Catamaran snorkel cruises are the most family-friendly option—stable boats, shallow and calm snorkel spots, life vests, and guides who help beginners. Tours to Malmok reef or Boca Catalina are great for kids seeing fish for the first time." },
    ],
  },
];
