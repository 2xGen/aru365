...
export const pillars: Pillar[] = [
  ...
  },
  {
    ...
    description:
      "Book reliable airport transfers in Aruba, including private cars, shared shuttles, and luxury transportation to and from your hotel.",
    subPages: [
      { label: "Private airport transfers", href: "/airport-transfers-in-aruba/private" },
      { label: "Shared shuttles", href: "/airport-transfers-in-aruba/shared" },
      { label: "Luxury transfers", href: "/airport-transfers-in-aruba/luxury" },
    ],
    relatedSlugs: ["private-and-luxury-tours-in-aruba", "island-sightseeing-tours-in-aruba"],
    faqs: [
      { question: "How do I get from Aruba airport to my hotel?", answer: "You can pre-book a private transfer, shared shuttle, or taxi. Pre-booking is recommended for convenience and often fixed pricing." },
      { question: "How long does the transfer from Aruba airport to the hotel strip take?", answer: "Most hotels are 15–25 minutes from the airport. Travel time depends on your hotel location and traffic." },
    ],
  },
  {
