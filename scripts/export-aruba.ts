/**
 * Export Aru365 content to a single JSON file for import into TopTours or other platforms.
 *
 * Run: npm run export:aruba
 * Output: aruba-export.json (project root)
 *
 * Structure:
...
const OUT_FILE = join(__dirname, "..", "aruba-export.json");
...
function main() {
  const payload = {
    ...
    destination: { slug: "aruba", name: "Aruba" },
